...
include("kdv_solve.jl") # Forward Euler
include("KdV_solver.jl") # RK2
...
function test_kdv()
	...
	#I. Qualitative test with Burgers equation (i.e. C2=0)
		...
		tvals, uhat, En, Mom, Ham = kdv_solve(pde_params, uhat_0, dt, tfin; dealias=true)
	...
	#II. Quantitative test using the exact solution of the linear Airy PDE (i.e. C3=0)
		...
		println("D=$(pde_params.D), C2=$(pde_params.C2), C3=$(pde_params.C3) | Estimated order = $(order)")
	...
	#III. Test conserved quantities of the KdV equation (i.e. D=0)
		...
		tvals2, uhat2, En2, Mom2, Ham2 = kdv_solve(pde_params, uhat_0, dt/2, tfin; dealias=true)
